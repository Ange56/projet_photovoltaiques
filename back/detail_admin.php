...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <link href="../front/css/detail_admin.css" rel="stylesheet">
        <link rel="icon" type="image/png" href="../images/logo.png">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
        <script src="../js/ajax.js" defer></script>
        <script src="../js/detail_admin.js" defer></script>
...
<body>
    ...
    <!-- Flèche de retour -->
    <a href="accueil.php" class="back-arrow" title="Retourner à la recherche">
        <img src="../images/fleche.png" alt="Retour">
    </a>
    <br>
    <main id="page" class="container my-5">
        <h3 id="info">Détails de l'installation: </h3>
